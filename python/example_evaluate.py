...
if test_dataset == 'oxford5k' or test_dataset == 'paris6k':
	# original evaluation
	map, aps, _, _ = compute_map(ranks, cfg['gnd'])
	print('>> {}: mAP {:.2f}'.format(test_dataset, np.around(map*100, decimals=2)))
elif test_dataset == 'roxford5k' or test_dataset == 'rparis6k':
